 ...
 * This class was not written by Amirali, it was written by Bita Mazloom
 * @author Bita M
 */
public class SuperMarket 
{
	...
	public static void main(String[] args) 
	{
		...
		//NOTE: Starting the tree with a "Z" at the root
		final String TESTFILE = "resources/DopeGroceryList.txt";
